...
public class TestBase {
	...
	public TestBase() {
		...
		try {
			...
			prop = new Properties();
			FileInputStream ip = new FileInputStream("F:\\CyberMart_Testing_Eclipse\\cyberMart_Test_Automation_Seller\\"
			+"src\\main\\java\\com\\cybermart\\qa\\config\\config.properties");
			prop.load(ip);
